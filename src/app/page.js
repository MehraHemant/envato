  ...
  return (
    <>
      <body className="home-purple-gradient">
          ...
          <div className="container">
            ...
            <div className="hero-countdown-wrap">
              ...
              <ul className="skill-feature_list">
                <li>
                  <span>Value</span> of technology invested
                </li>
                <li>
                  <span>Private</span> sale
                </li>
                <li>
                  <h4>ICO</h4>
                </li>
        ...
        <div
          className="wcu-area-1 pt-130 pb-140 position-relative"
          id="feature"
        >
              ...
              <div className="row gy-5">
                <div className="col-lg-7">
                  <div className="section-title mb-0">
                    ...
                    <p className="sec-text">
                      Use the window for the planned investment and calculate
                      the estimated <br /> Iko price and your monthly dividends
                      at a fixed time
                    </p>
                  </div>
                </div>
                <div className="col-lg-5">
                  <div className="wcu-thumb text-center alltuchtopdown">
                    <img
                      src="/assets/img/update/normal/why_1-1.png"
                      alt="img"
                    />
                  </div>
                </div>
              ...
              <div className="col-lg-6">
                <div className="feature-card">
                  <div className="feature-card-icon">
                    <img
                      src="/assets/img/update/icon/feature-icon1-1.svg"
                      alt="img"
                    />
                  </div>
                ...
                <div className="feature-card">
                  <div className="feature-card-icon">
                    <img
                      src="/assets/img/update/icon/feature-icon1-2.svg"
                      alt="img"
                    />
                  </div>
                  <div className="feature-card-details">
                ...
                <div className="feature-card">
                  <div className="feature-card-icon">
                    <img
                      src="/assets/img/update/icon/feature-icon1-3.svg"
                      alt="img"
                    />
                  </div>
                  <div className="feature-card-details">
            ...
            <div className="row justify-content-between">
              <div className="col-xl-4">
                <div className="intro-wrap mt-xl-4">
                  ...
                  <p className="intro-wrap-text">
                    ...
                    security token (applies to all transactions and gives a
                    monthly dividend)
                  </p>
                </div>
                <div className="intro-wrap">
                  ...
                  <p className="intro-wrap-text">
                    Users with Iko have lower system fees Price growth is
                    gathered by demand for Unifox technologies. You own a stake
                    in an international corporation. You are part of the
                    community
                  </p>
                </div>
                <div className="intro-wrap">
                  ...
                  <p className="intro-wrap-text">
                    The underlying growth attracts investors The whole community
                    is interested in growing the Iko prize. The company is
                    planning to continue to expand the project, and it will cost
                    the top up
                  </p>
                </div>
              </div>
              <div className="col-xl-6">
                ...
                <div className="intro-wrap mt-50">
                  ...
                  <p className="intro-wrap-text">
                    Iko is a 100% pre-scratched cryptome There are 1 Million
                    Minutes, and 60% of them can be yours (60% - ICO) Utility &
                    security token (applies to all transactions and gives a
                    monthly dividend)
                  </p>
                  ...
                  <p className="intro-wrap-text mt-40">
                    Iko is a 100% pre-scratched cryptome There are 1 Million
                    Minutes, and 60% of them can be yours (60% - ICO)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row justify-content-between">
              ...
              <div className="col-sm-auto">
                <div className="icon-box">
                  <button className="slider-arrow prev-btn default">
                    <i className="fas fa-arrow-left"></i>
                  </button>
                  <button className="slider-arrow next-btn default">
            ...
            <div className="row gy-30">
              <div className="col-lg-3 col-md-6">
                <div className="invest-card">
                  <div className="invest-card-icon">
                    <img
                      src="/assets/img/update/invest/invest-icon-1.png"
                      alt="icon"
                    />
                  </div>
              ...
              <div className="col-lg-3 col-md-6">
                <div className="invest-card">
                  <div className="invest-card-icon">
                    <img
                      src="/assets/img/update/invest/invest-icon-2.png"
                      alt="icon"
                    />
                  </div>
                  <a className="btn btn3" href="#">
              ...
              <div className="col-lg-3 col-md-6">
                <div className="invest-card">
                  <div className="invest-card-icon">
                    <img
                      src="/assets/img/update/invest/invest-icon-3.png"
                      alt="icon"
                    />
                  </div>
                  <a className="btn btn3" href="#">
              ...
              <div className="col-lg-3 col-md-6">
                <div className="invest-card">
                  <div className="invest-card-icon">
                    <img
                      src="/assets/img/update/invest/invest-icon-4.png"
                      alt="icon"
                    />
                  </div>
                  <a className="btn btn3" href="#">
              ...
              <div className="row gy-4 justify-content-center">
                <div className="col-lg-6">
                  <div className="founder-card">
                    <div className="founder-card-img">
                      <img
                        src="/assets/img/update/team/founder-1-1.png"
                        alt="img"
                      />
                    </div>
                ...
                <div className="col-lg-6">
                  <div className="founder-card">
                    <div className="founder-card-img">
                      <img
                        src="/assets/img/update/team/founder-1-2.png"
                        alt="img"
                      />
                    </div>
                    <div className="founder-card-details">
                    ...
                    <ul className="team-tab-list">
                      <li>
                        <div className="team-card">
                          <div className="team-card_img">
                            <img
                              src="/assets/img/update/team/team-1-1.png"
                              alt="Team Image"
                            />
                            <div className="social-btn">
                              <a href="https://www.linkedin.com/">
                      ...
                      <li>
                        <div className="team-card">
                          <div className="team-card_img">
                            <img
                              src="/assets/img/update/team/team-1-2.png"
                              alt="Team Image"
                            />
                            <div className="social-btn">
                              <a href="https://www.linkedin.com/">
                      ...
                      <li>
                        <div className="team-card">
                          <div className="team-card_img">
                            <img
                              src="/assets/img/update/team/team-1-3.png"
                              alt="Team Image"
                            />
                            <div className="social-btn">
                              <a href="https://www.linkedin.com/">
                      ...
                      <li>
                        <div className="team-card">
                          <div className="team-card_img">
                            <img
                              src="/assets/img/update/team/team-1-4.png"
                              alt="Team Image"
                            />
                            <div className="social-btn">
                              <a href="https://www.linkedin.com/">
                      ...
                      <li>
                        <div className="team-card">
                          <div className="team-card_img">
                            <img
                              src="/assets/img/update/team/team-1-5.png"
                              alt="Team Image"
                            />
                            <div className="social-btn">
                              <a href="https://www.linkedin.com/">
                      ...
                      <li>
                        <div className="team-card">
                          <div className="team-card_img">
                            <img
                              src="/assets/img/update/team/team-1-6.png"
                              alt="Team Image"
                            />
                            <div className="social-btn">
                              <a href="https://www.linkedin.com/">
                      ...
                      <li>
                        <div className="team-card">
                          <div className="team-card_img">
                            <img
                              src="/assets/img/update/team/team-1-7.png"
                              alt="Team Image"
                            />
                            <div className="social-btn">
                              <a href="https://www.linkedin.com/">
                      ...
                      <li>
                        <div className="team-card">
                          <div className="team-card_img">
                            <img
                              src="/assets/img/update/team/team-1-8.png"
                              alt="Team Image"
                            />
                            <div className="social-btn">
                              <a href="https://www.linkedin.com/">
                      ...
                      <li>
                        <div className="team-card">
                          <div className="team-card_img">
                            <img
                              src="/assets/img/update/team/team-1-9.png"
                              alt="Team Image"
                            />
                            <div className="social-btn">
                              <a href="https://www.linkedin.com/">
                      ...
                      <li>
                        <div className="team-card">
                          <div className="team-card_img">
                            <img
                              src="/assets/img/update/team/team-1-10.png"
                              alt="Team Image"
                            />
                            <div className="social-btn">
                              <a href="https://www.linkedin.com/">
              ...
              <div className="row partner-slider1">
                <div className="col-lg-4">
                  <div className="partner-card">
                    <div className="partner-card-img">
                      <img
                        src="/assets/img/update/client/client-1-4.svg"
                        alt="img"
                      />
                    </div>
                    <p className="partner-card-text">
                      Stable crypto currency and an important part of the UniFox
                      ecosystem
                    </p>
                    <a className="btn btn3" href="blog.html">
                      EXPLORE
                    </a>
                  </div>
                </div>
                <div className="col-lg-4">
                  <div className="partner-card">
                    <div className="partner-card-img">
                      <img
                        src="/assets/img/update/client/client-1-2.svg"
                        alt="img"
                      />
                    </div>
                    <p className="partner-card-text">
                      Online exchanger, specializing in the exchange of private
                      individuals
                    </p>
                    <a className="btn btn3" href="blog.html">
                      EXPLORE
                ...
                <div className="col-lg-4">
                  <div className="partner-card">
                    <div className="partner-card-img">
                      <img
                        src="/assets/img/update/client/client-1-5.svg"
                        alt="img"
                      />
                    </div>
                    <p className="partner-card-text">
                      A company that provides all IT services within the
                      ecosystem of UniFox
                    </p>
                    <a className="btn btn3" href="blog.html">
                      EXPLORE
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="event-card">
                    <div className="event-card-img">
                      <a href="#">
                        <img
                          src="/assets/img/update/event/1-1.png"
                          alt="blog image"
                        />
                      </a>
                    </div>
                    <div className="event-card-content">
                      <h4 className="event-card-title">
                        <a href="contact.html">BlockVienna</a>
                      </h4>
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="event-card">
                    <div className="event-card-img">
                      <a href="#">
                        <img
                          src="/assets/img/update/event/1-2.png"
                          alt="blog image"
                        />
                      </a>
                    </div>
                    <div className="event-card-content">
                      <h4 className="event-card-title">
                        <a href="contact.html">Summit Summits</a>
                      </h4>
                      <div className="event-meta">
                        <a href="#">
                          <svg
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="event-card">
                    <div className="event-card-img">
                      <a href="#">
                        <img
                          src="/assets/img/update/event/1-3.png"
                          alt="blog image"
                        />
                      </a>
                    </div>
                    <div className="event-card-content">
                      <h4 className="event-card-title">
                        <a href="contact.html">Blockchain Summit</a>
                      </h4>
                      <div className="event-meta">
                        <a href="#">
                          <svg
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="event-card">
                    <div className="event-card-img">
                      <a href="#">
                        <img
                          src="/assets/img/update/event/1-4.png"
                          alt="blog image"
                        />
                      </a>
                    </div>
                    <div className="event-card-content">
                      <h4 className="event-card-title">
                        <a href="contact.html">Economy ICO 2024</a>
                      </h4>
                      <div className="event-meta">
                        <a href="#">
                          <svg
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="event-card">
                    <div className="event-card-img">
                      <a href="#">
                        <img
                          src="/assets/img/update/event/1-5.png"
                          alt="blog image"
                        />
                      </a>
                    </div>
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="event-card">
                    <div className="event-card-img">
                      <a href="#">
                        <img
                          src="/assets/img/update/event/1-6.png"
                          alt="blog image"
                        />
                      </a>
                    </div>
                    <div className="event-card-content">
                      <h4 className="event-card-title">
                        <a href="contact.html">Blockchain & bitcoin</a>
                      </h4>
                      <div className="event-meta">
                        <a href="#">
                          <svg
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="event-card">
                    <div className="event-card-img">
                      <a href="#">
                        <img
                          src="/assets/img/update/event/1-7.png"
                          alt="blog image"
                        />
                      </a>
                    </div>
                    <div className="event-card-content">
                      <h4 className="event-card-title">
                        <a href="contact.html">Money conference</a>
                      </h4>
                      <div className="event-meta">
                        <a href="#">
                          <svg
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="event-card">
                    <div className="event-card-img">
                      <a href="#">
                        <img
                          src="/assets/img/update/event/1-8.png"
                          alt="blog image"
                        />
                      </a>
                    </div>
                    <div className="event-card-content">
                      <h4 className="event-card-title">
                        <a href="contact.html">Crypto Economy </a>
                      </h4>
                      <div className="event-meta">
                        <a href="#">
                          <svg
              ...
              <div className="cta-slider1 row">
                <div className="col-lg-6">
                  <div className="cta-wrap1">
                    <div className="cta-wrap-details">
                      <img
                        src="/assets/img/update/client/press-1-1.svg"
                        alt="img"
                      />
                      <h3 className="cta-wrap-title">huffpost.com</h3>
                      <p className="cta-wrap-text">
                        UniFox seeks to incorporate cryptocurrencies into
                        everyday life through the introduction of their
                        autonomous design.
                      </p>
                    </div>
                    <a className="btn btn4" href="blog.html">
                      READ MORE
                    </a>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="cta-wrap1">
                    <div className="cta-wrap-details">
                      <img
                        src="/assets/img/update/client/press-1-2.svg"
                        alt="img"
                      />
                      <h3 className="cta-wrap-title">msnbc.com</h3>
                      <p className="cta-wrap-text">
                        In excellence from Tether or love another "stable"
                        crippling. Unicash can easily be converted to local
                        currency by special bankers{" "}
                      </p>
                    </div>
                    <a className="btn btn4" href="blog.html">
                      READ MORE
                ...
                <div className="col-lg-6">
                  <div className="cta-wrap1">
                    ...
                    <a className="btn btn4" href="/blog">
                      READ MORE
                    </a>
                  </div>
                </div>
                ...
                <div className="accordion-area accordion" id="faqAccordion">
                  <div className="accordion-card active">
                    <div className="accordion-header" id="collapse-item-1">
                      ...
                      >
                        <span className="number">1</span> How to buy FOX tokens?
                      </button>
                    </div>
                    <div
                      id="collapse-1"
                  ...
                  <div className="accordion-card">
                    <div className="accordion-header" id="collapse-item-2">
                      ...
                      >
                        <span className="number">2</span> What is the value of
                        FOX tokens?
                      </button>
                    </div>
                    <div
                  ...
                  <div className="accordion-card">
                    <div className="accordion-header" id="collapse-item-3">
                      ...
                      >
                        <span className="number">3</span> What is the value of
                        FOX tokens?
                      </button>
                    </div>
                    <div
                  ...
                  <div className="accordion-card">
                    <div className="accordion-header" id="collapse-item-4">
                      ...
                      >
                        <span className="number">4</span> How are coins
                        distribut ed?
                      </button>
                    </div>
                    <div
                  ...
                  <div className="accordion-card">
                    <div className="accordion-header" id="collapse-item-5">
                      ...
                      >
                        <span className="number">5</span> How to buy FOX tokens?
                      </button>
                    </div>
                    <div
                      id="collapse-5"
              ...
              <div className="row gy-3 justify-content-between align-items-center">
                <div className="col-lg-6 align-self-center">
                  <p className="copyright-text">
                    Copyright © 2024 <a href="#">IKO.</a> All rights reserved.
                  </p>
                </div>
                <div className="col-lg-6 text-lg-end">
                  <ul className="footer-links">
                    <li>
                      <a href="blog.html">Job & Career</a>
                    </li>
                    <li>
                      <a href="contact.html">Terms and Condition</a>
                    </li>
                    <li>
